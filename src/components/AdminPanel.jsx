...
import { Lock, Users, Calendar, Clock, CheckCircle, XCircle, Home, Eye, EyeOff } from 'lucide-react';
...
const AdminPanel = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      ...
      setExamResults(results.sort((a, b) => b.id - a.id)); // Sort by newest first
    }
  }, [isAuthenticated]);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-yellow-600 font-semibold">Intellect-Group</p>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <div className="text-2xl font-bold text-gray-800">
              {examResults.filter(r => r.percentage >= 75).length}
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <div className="text-2xl font-bold text-gray-800">
              {examResults.filter(r => r.percentage >= 50 && r.percentage < 75).length}
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <div className="text-2xl font-bold text-gray-800">
              {examResults.filter(r => r.percentage < 50).length}
            </div>
